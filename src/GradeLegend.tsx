...
export default function GradeLegend({
  ...
  mask,
  grading,
  title = 'Abgestufte Befahrbarkeit',
}: {
  ...
  return (
    <div className="grade-legend">
      ...
      {grading && (
        <small className="grade-bands">
          Grenzen auf dem normierten Schwellenabstand: sicher ab {grading.bands.safe_min_margin}, gut ab {grading.bands.good_min_margin},
          Risikoband ab {grading.bands.risky_min_margin}.
        </small>
      )}
